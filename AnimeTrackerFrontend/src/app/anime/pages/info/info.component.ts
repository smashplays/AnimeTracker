...
export class InfoComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.userService.me().subscribe((res) => {
      this.userInfor = res;
      this.animeService
        .checkAnimeUser(this.userInfor.data.id, this.selectedAnime.data.mal_id)
        .subscribe((res) => {
          this.addButton = '➕';
  ...
  addedTrue() {
    ...
    if (
      this.animeService
        .checkAnime(this.selectedAnime.data.mal_id)
        .pipe(
          catchError((err) => {
            if (err.status === 404) {
              this.animeService
                ...
                .subscribe((animeAdd) => {
                  ...
                  this.animeService
                    .getAnimeEpisodes(this.selectedAnime.data.mal_id)
                    .subscribe((res) => {
                      console.log(res);
                      ...
                      this.animeService
                        .addAnimeEpisodes(this.capitulosA)
                        .subscribe((res) =>
